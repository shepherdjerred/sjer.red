...
This is an adaptation of my senior [seminar paper](https://github.com/shepherdjerred-homework/seminar-paper), originally written in LaTeX. You can view the original [here]().
...
<figure>
    ...
    ```
    <figcaption>
      Figure 5, a projection matrix where a is the aspect ratio, `fov` is the field of view, `z_f` is z-far, and `z_n` is z-near (hernandez2019).
    </figcaption>
</figure>
