...
description: How I build Discord Plays Pokemon
date: 2024-07-06Z-0700
...
Use a headful browser (Chrome) running Pokemon with [EmulatorJS](https://emulatorjs.org/). Stream the video of headless browser to Discord. Use the stream video as a webcam input and pipe the audio as a microphone input.
