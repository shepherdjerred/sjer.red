...
I lost my job at [Posit](https://posit.co/) rather suddenly on June 21st. This ended up being rather convenient since had already been looking for a new job and it's significantly easier to LeetCode while you're unemployed. I found a great spot at Pinterest after about ~2 months of studying, applying, and interviewing. I'm very happy to say that today is my first day.
...
- Track your applications using [Todoist](https://todoist.com/), a spreadsheet, anything.
...
I started by applying with a barely updated version of my résumé. As
...
Some people reccommend using LinkedIn to find jobs. I wasn't able to take this approach since I don't have a LinkedIn.

### Tracking Applications

I used [Todoist](https://todoist.com/) to track my applications. It's very useful to know at a glance what you're doing and where you want to apply next. I had columns for each status that I wanted to track.
...
[My résumé](https://github.com/shepherdjerred/resume/) is written using a [LaTeX template](https://github.com/sb2nov/resume).
...
- https://www.levels.fyi/services/resume (I didn't use this, but it looks interesting)
...
I used Anki to memorize common algorithms, Java APIs, or other information I might need to know during an interview. I used [algodeck](https://github.com/teivah/algodeck) as a starting point while adding my own cards for anything additional that I needed to know.

#### More Resources

Here are some other resources that might be helpful. There are some more structured courses/sites below that might work well if you have plenty of time to prepare.
