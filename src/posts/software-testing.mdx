...
> Aside: Unit tests can be great if the project is well-architected and if the project is in a language that lends itself well to unit testing. I've had a great experience with unit testing in Java and absolutely terrible experiences with JavaScript.
